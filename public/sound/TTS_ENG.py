# -*- coding: utf-8 -*-
"""
Created on Sat Dec  4 19:22:31 2021
...
import fitz
import regex as re
path = 'C:/Users/Upekkha Lau/Desktop/ProDS/GoogleTextToSpeech/GoogleTTS/Data/Inggris/'
filelist = os.listdir(path)
    
for book in filelist:
    path = 'C:/Users/Upekkha Lau/Desktop/ProDS/GoogleTextToSpeech/GoogleTTS/Data/Inggris/' + book
    file = fitz.open(path)
    ...
    #setting TTS EN
    voiceEn = texttospeech_v1.VoiceSelectionParams(
        language_code='en-US',
        ssml_gender=texttospeech_v1.SsmlVoiceGender.MALE
    )
    audio_configEn = texttospeech_v1.AudioConfig(
